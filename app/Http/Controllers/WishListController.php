...
//            return back()->with('message','Please login/register for add to wishlist.');
            return redirect('/login-register')->with('message', 'Please login/register for add to wishlist.');
